...
knitr::kable(TukeyHSD(aov(TEMP_AVERAGE ~ factor(YEAR), data = f))[["factor(YEAR)"]], caption = "TukeyHSD Fall (TEMP_AVERAGE ~ factor(YEAR))")
knitr::kable(TukeyHSD(aov(TEMP_AVERAGE ~ factor(YEAR), data = w))[["factor(YEAR)"]], caption = "TukeyHSD Winter (TEMP_AVERAGE ~ factor(YEAR))")
knitr::kable(TukeyHSD(aov(TEMP_AVERAGE ~ factor(YEAR), data = s))[["factor(YEAR)"]], caption = "TukeyHSD Spring (TEMP_AVERAGE ~ factor(YEAR))")
