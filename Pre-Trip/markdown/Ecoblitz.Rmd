...
<center><h1>Temperature Analysis</h1>


<center><h2>Seasonal</h2>
...
knitr::kable(TukeyHSD(aov(TEMP_AVERAGE ~ factor(YEAR), data = Spring))[["factor(YEAR)"]], caption = "tukey_result_ave_spring P= 0.0299, p<0.05 significant 2023 is different ")

knitr::kable(TukeyHSD(aov(TEMP_MAX ~ factor(YEAR), data = Spring))[["factor(YEAR)"]], caption = "tukey_result_max_spring p = 0.0105, significant 2023 is different ")

knitr::kable(TukeyHSD(aov(TEMP_MIN ~ factor(YEAR), data = Spring))[["factor(YEAR)"]], caption = "tukey_result_min_spring - p= 0.238, NOT significant All same/similar")

knitr::kable(tukey_result_fall <- TukeyHSD(aov(Fall$TEMP_AVERAGE ~ factor(YEAR), data = Fall))[["factor(YEAR)"]], caption = "tukey_result_fall - p< 0.05, p= 0.00418, significant, 2022 is different")

knitr::kable(TukeyHSD(aov(Fall$TEMP_MAX ~ factor(YEAR), data = Fall))[["factor(YEAR)"]], caption = "anova_fall_max - p=0.00314 significant 2022 is different")

knitr::kable(TukeyHSD(aov(Fall$TEMP_MIN ~ factor(YEAR), data = Fall))[["factor(YEAR)"]], caption = "tukey_fall_min - p=0.00311 significant, 2022-2021 is different??")
...
<center><h2>Week 1 Temperature Analysis</h2>

<center><h3>Stats</h3>

```{r 2.3, include=TRUE,echo=FALSE, message=FALSE, warning=FALSE}

knitr::kable(TukeyHSD(aov(TEMP_AVERAGE ~ factor(YEAR), data = Spring_week))[["factor(YEAR)"]], caption = "Spring_week_Average - P= 0.000484, p<0.05 significant, 2021 is different with 90% sig level ")

knitr::kable(TukeyHSD(aov(TEMP_MAX ~ factor(YEAR), data = Spring_week))[["factor(YEAR)"]], caption = "Spring_week_Max - p = 0.00217, significant, 2021 is different with 90% sig level")

knitr::kable(TukeyHSD(aov(TEMP_MIN ~ factor(YEAR), data = Spring_week))[["factor(YEAR)"]], caption = "Spring_week_Min - p= 0.0807, NOT significant, 2023-2021 is different")

knitr::kable(TukeyHSD(aov(TEMP_AVERAGE ~ factor(YEAR), data = Fall_week))[["factor(YEAR)"]], caption = "Fall_week_Average - p< 0.05, p= 0.000479, significant, 2023 is different")

knitr::kable(TukeyHSD(aov(TEMP_MAX ~ factor(YEAR), data = Fall_week))[["factor(YEAR)"]], caption = "Fall_week_Max - p=0.000185 significant, 2023 is different")

knitr::kable(TukeyHSD(aov(TEMP_MIN ~ factor(YEAR), data = Fall_week))[["factor(YEAR)"]], caption = "Fall_week_Min - p=0.177 NOT significant, All same ")
